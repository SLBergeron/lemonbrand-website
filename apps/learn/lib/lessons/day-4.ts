...
Feedback from real people is worth 10x your own assumptions. You're not asking "Is this perfect?" You're asking "What's confusing? What would make this better?"`,
    ...
    // Form
    {
      ...
      description:
        "Your answers shape tomorrow's expansion priorities.",
      fields: [
        {
          id: "deploy-experience",
          label: "How did deployment go?",
          type: "radio",
          options: [
            { value: "smooth", label: "Smooth" },
            { value: "broke-fixed", label: "Broke but fixed it" },
            { value: "fighting", label: "Still fighting it" },
          ],
          required: true,
        },
        {
          id: "deploy-issues",
          label: "What broke and how did you fix it?",
          type: "textarea",
          placeholder: "During deploy, I ran into...",
          voiceEnabled: true,
          conditionalOn: {
            fieldId: "deploy-experience",
            operator: "neq",
            value: "smooth",
          },
        },
        ...
        {
          id: "feedback",
          label: "Who saw it, and what did they say?",
          type: "textarea",
        ...
        },
        {
          ...
          label: "Top 2-3 improvements based on feedback?",
          type: "textarea",
          placeholder: "1. ... 2. ... 3. ...",
          required: true,
          voiceEnabled: true,
          helpText: "Tomorrow's tips will directly reference these.",
        },
      ],
      submitLabel: "Shipped — What's Next",
    },
