...
This is why we've been committing to GitHub. Your working code is saved.`,
    ...
    // Form
    {
      id: "reflection-form",
      type: "form",
      title: "Polish + Ship Prep",
      description: "Your answers here personalize tomorrow's demo tips for your specific project.",
      fields: [
        {
          id: "not-added",
          label: "What did you choose NOT to add today? Why was that the right call?",
          type: "textarea",
          placeholder: "I wanted to add... but I didn't because...",
          required: true,
          voiceEnabled: true,
        },
        {
          ...
          type: "textarea",
          placeholder: "Claude found that... I fixed...",
          required: true,
          voiceEnabled: true,
        },
        {
          ...
          type: "textarea",
          placeholder: "The security check showed...",
          voiceEnabled: true,
        },
        {
          id: "one-sentence",
