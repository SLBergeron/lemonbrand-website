...
└── ... (other config files Claude creates)`,
    ...
    // Form
    {
      ...
      description: "Your answers here personalize tomorrow's deploy tips for your specific project.",
      fields: [
        {
          id: "github-link",
        ...
        },
        {
          ...
          type: "textarea",
          placeholder: "When I open localhost:3000 I see...",
          required: true,
          voiceEnabled: true,
        },
        {
          ...
          type: "textarea",
          placeholder: "The main things that need work are...",
          required: true,
          voiceEnabled: true,
        ...
        },
        {
          ...
          options: [
            ...
            { value: "useful-frustrating", label: "Useful but frustrating at times" },
