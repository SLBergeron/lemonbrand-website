...
**HTML is your thinking tool.** Use it freely.`,
    ...
    // Form
    {
      ...
      description: "What did you learn by seeing your project visualized?",
      fields: [
        {
          id: "visualization",
          label: "Upload your plan-visual.html or a screenshot",
          type: "text",
        ...
        },
        {
          id: "insight",
          label:
            "What did you learn about your project by seeing it visualized?",
          type: "textarea",
