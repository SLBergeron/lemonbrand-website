...
const programs = [
  {
    ...
    description:
      "Days 0-1 free. $297 to unlock Days 2-7. Build YOUR project (not a tutorial). Ship something real by Day 7. Your $297 becomes credit toward the 8-Week.",
...
Days 0-1 are free, $297 unlocks the full Sprint. You ship something real. If you complete all 7 days, your $297 becomes credit toward the 8-Week.
...
The Sprint is free to start (Days 0-1), fast (7 days), and proves you can do this. Plus, your $297 becomes credit toward the 8-Week if you complete it.
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <span className="text-foreground font-medium">Start with the Sprint.</span> Days
                    0-1 are free, $297 unlocks the full Sprint.
                  </p>
                  <p>
