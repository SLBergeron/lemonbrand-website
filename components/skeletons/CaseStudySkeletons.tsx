...
// SkeletonOne - Avatars with scores
  ...
  const Score = () => {
    return (
      <motion.span
        ...
        className="absolute inset-x-0 bottom-4 m-auto h-fit w-fit rounded-md border border-neutral-100 bg-white px-2 py-1 text-xs text-neutral-600"
      >
        ...
        {avatars.map((avatar, index) => (
          ...
          >
            ...
            <Image
              ...
              width={100}
              height={140}
              className="h-[120px] w-full rounded-lg object-cover object-top"
            />
          </motion.div>
        ))}
      </div>
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="group/bento relative flex h-full flex-col overflow-hidden px-2 py-8">
...
export const SkeletonThree = () => {
  ...
  return (
    <motion.div className="relative h-full pb-4">
      ...
      <div className="relative z-20 mx-auto grid max-w-[calc(100%-4rem)] grid-cols-2 justify-center gap-4 pt-8">
        <div className="relative rounded-lg border border-neutral-200 bg-neutral-100 p-2 dark:border-neutral-700 dark:bg-neutral-800">
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 mx-auto w-fit rounded-md bg-white px-2 py-1 text-xs text-neutral-600 opacity-0 dark:bg-neutral-600 dark:text-white"
          >
            Hello, My name...
          </motion.div>
          <Image
...
export const SkeletonFour = () => {
  return (
    <div className="h-full w-full overflow-hidden flex items-center justify-center bg-neutral-50 dark:bg-neutral-800/50">
      <motion.div
        whileHover="animate"
      ...
      >
        <motion.div
          ...
          className={cn(
            "relative z-40 flex h-32 w-32 items-center justify-center rounded-md bg-white dark:bg-neutral-900",
        ...
        <motion.div
          ...
          className="absolute inset-0 z-30 flex h-32 w-32 items-center justify-center rounded-md border border-dashed border-sky-400 bg-transparent opacity-0"
        ></motion.div>
      </motion.div>
    </div>
  );
