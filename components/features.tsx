  ...
  return (
    <div className="relative w-fit mx-auto p-4 flex items-center justify-center">
      <motion.div
        ...
        className="absolute inset-0 h-full border border-orange-500/50 dark:border-orange-500/30 w-full shadow-[0_0_15px_rgba(249,115,22,0.3)]"
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -top-1 -left-1 h-2 w-2 bg-orange-500 dark:bg-orange-500 shadow-[0_0_10px_rgba(249,115,22,0.6)]"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -top-1 -right-1 h-2 w-2 bg-yellow-500 dark:bg-yellow-500 shadow-[0_0_10px_rgba(234,179,8,0.6)]"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -bottom-1 -left-1 h-2 w-2 bg-yellow-500 dark:bg-yellow-500 shadow-[0_0_10px_rgba(234,179,8,0.6)]"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.1, ease: "easeInOut" }}
          className="absolute -bottom-1 -right-1 h-2 w-2 bg-orange-500 dark:bg-orange-500 shadow-[0_0_10px_rgba(249,115,22,0.6)]"
        />
      </motion.div>
      {children}
    </div>
...
const GitHubLogo = () => {
  return (
    <svg
      ...
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
      className="h-8 w-8 object-contain text-neutral-600 dark:text-white"
    >
      <g
        id="Page-1"
        stroke="none"
...
const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "font-sans text-base font-normal tracking-tight mt-2 text-neutral-500 dark:text-neutral-400",
        className
      )}
    >
      {children}
