    ...
    >
      <div className="max-w-7xl mx-auto 0 flex flex-col md:flex-row justify-between items-center w-full">
        <div className="flex flex-col">
          <motion.h2 className="text-neutral-600 dark:text-white text-xl text-center md:text-left md:text-3xl font-bold mx-auto md:mx-0 max-w-xl ">
            Found the automation opportunity.<br />
            Let&apos;s build it.
          </motion.h2>
          <p className="max-w-md mt-8 text-center md:text-left text-sm md:text-base mx-auto md:mx-0 text-neutral-600 dark:text-neutral-400">
            No-bullshit operations. We install bespoke AI systems that grow your bottom line.
            75+ workflows shipped across sales, marketing, and ops.
          </p>
          <FeaturedImages
