...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="rounded-[24px] border border-neutral-200 bg-white p-2 dark:border-neutral-700 dark:bg-neutral-600">
          <VideoThumbnail
            previewSrc="/videos/Trim_VSL-02.mp4"
            posterSrc="/videos/poster_fallback_vsl.webp"
