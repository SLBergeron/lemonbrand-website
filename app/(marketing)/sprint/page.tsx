              ...
              >
                <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-8 sm:p-10 shadow-lg max-w-2xl mx-auto">
                  <div className="space-y-6 text-center">
                    ...
                    {/* Cohort Info */}
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 border-t border-border/50 text-sm text-muted-foreground">
      ...
      <section className="py-20 px-4 bg-primary text-primary-foreground">
        <Section className="py-0 px-0">
          <div className="space-y-6 text-center max-w-2xl mx-auto">
            ...
            <p className="text-lg font-medium">If it&apos;s the first one, join.</p>
